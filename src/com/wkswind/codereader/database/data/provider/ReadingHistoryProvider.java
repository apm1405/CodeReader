...
import com.wkswind.codereader.database.data.provider.ReadingHistoryContent.Wish;
 ...
 */
public final class ReadingHistoryProvider extends ContentProvider {

    private static final String LOG_TAG = ReadingHistoryProvider.class.getSimpleName();

    /* package */ static final boolean ACTIVATE_ALL_LOGS = false;

    protected static final String DATABASE_NAME = "ReadingHistoryProvider.db";

    public static final String AUTHORITY = "com.wkswind.codereader.database.provider.ReadingHistoryProvider";
    ...
    private enum UriType {
        WISH(Wish.TABLE_NAME, Wish.TABLE_NAME, Wish.TYPE_ELEM_TYPE),
        WISH_ID(Wish.TABLE_NAME + "/#", Wish.TABLE_NAME, Wish.TYPE_DIR_TYPE);
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            Log.d(LOG_TAG, "Creating ReadingHistoryProvider database");
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            Wish.upgradeTable(db, oldVersion, newVersion);
        }
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        try {
            switch (uriType) {
                case WISH:
                    insertStmt = db.compileStatement(Wish.getBulkInsertString());
                    for (ContentValues value : values) {
                        Wish.bindValuesInBulkInsert(insertStmt, value);
                        insertStmt.execute();
